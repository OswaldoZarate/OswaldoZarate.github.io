...
function buildTable(data) {
  ...
  document.getElementById("Summary").innerHTML = specific_recipe.Summary;
  ...
  var image_substring = "750x750.jpg";
  ...
  document.getElementById("image2").src = specific_recipe.Image2;
  document.getElementById("image3").src = specific_recipe.Image3;
  document.getElementById("image4").src = specific_recipe.Image4; 
  document.getElementById("image5").src = specific_recipe.Image5; 
...
function handleClickSearch() {
    ...
    if (query) {
        ...
        var url = "https://comida-aleatoria.herokuapp.com/api/search/";
